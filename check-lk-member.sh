...
# Check members endpoint with search
echo "Checking if LK Holding member exists with legal_entity_id 8fc8562b-96d5-4a97-9195-a8682abefee5..."
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://ca-ctn-asr-api-dev.calmriver-700a8c55.westeurope.azurecontainerapps.io/api/v1/all-members" | \
  jq '.data[] | select(.legal_entity_id == "8fc8562b-96d5-4a97-9195-a8682abefee5")'
