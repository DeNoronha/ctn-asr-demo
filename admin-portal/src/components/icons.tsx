...
export const AlertCircle: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="⚠️" label="Alert" />
);
export const Key: React.FC<IconProps> = (props) => <Icon {...props} icon="🔑" label="Key" />;
export const ShieldAlert: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="🛡️⚠️" label="Shield Alert" />
);
export const ShieldX: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="🛡️❌" label="Shield X" />
);
...
export const ExternalLink: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="🔗" label="Link" />
);
export const HelpCircle: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="❓" label="Help" />
);
...
export const CheckSquare: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="☑️" label="Check Square" />
);
export const CreditCard: React.FC<IconProps> = (props) => (
  <Icon {...props} icon="💳" label="Credit Card" />
);
...
export const Sun: React.FC<IconProps> = (props) => <Icon {...props} icon="☀️" label="Light mode" />;
export const Moon: React.FC<IconProps> = (props) => <Icon {...props} icon="🌙" label="Dark mode" />;
