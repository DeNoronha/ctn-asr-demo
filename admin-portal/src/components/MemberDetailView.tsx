...
export const MemberDetailView: React.FC<MemberDetailViewProps> = ({ member, onBack }) => {
  ...
  const handleIdentifierCreate = async (
    ...
    try {
      ...
      // Check if EUID was auto-generated (dynamic property from API)
      const euidAutoGenerated = 'euid_auto_generated' in newIdentifier &&
  ...
  const handleIdentifierUpdate = async (
    ...
    try {
      ...
      // Check if EUID was auto-updated (dynamic property from API)
      const euidAutoUpdated = 'euid_auto_updated' in updated &&
