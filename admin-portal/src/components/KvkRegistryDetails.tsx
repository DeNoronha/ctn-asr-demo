      ...
      {error ? (
        ...
        <div className="kvk-registry-details">
          ...
          <div className="registry-grid">
            ...
            <Card withBorder shadow="sm" padding="lg">
              ...
              <div className="card-body">
                <div className="info-table">
                  ...
                  {registryData.statutory_name &&
                    registryData.statutory_name !== registryData.company_name && (
                      <div className="info-row">
                      ...
                      ? registryData.trade_names.length > 0 && (
                          <div className="info-row">
                            <span className="info-label">
                              Trade Name{registryData.trade_names.length > 1 ? 's' : ''}:
                            </span>
                            <span className="info-value">
                              {(registryData.trade_names as KvkTradeName[])
                                .map((tn) => tn.naam)
                                .join(', ')}
                            </span>
                          </div>
                  ...
                  {registryData.rechtsvorm &&
                    registryData.rechtsvorm !== registryData.legal_form && (
                      <div className="info-row">
            ...
            registryData.fulltime_employees ||
            registryData.parttime_employees ||
              ...
              <Card withBorder shadow="sm" padding="lg">
                ...
                <div className="card-body">
                  <div className="info-table">
                    ...
                    {registryData.fulltime_employees !== null &&
                      registryData.fulltime_employees !== undefined && (
                        <div className="info-row">
                          <span className="info-label">Full-time:</span>
                          <span className="info-value">{registryData.fulltime_employees}</span>
                        </div>
                      )}
                    {registryData.parttime_employees !== null &&
                      registryData.parttime_employees !== undefined && (
                        <div className="info-row">
                          <span className="info-label">Part-time:</span>
                          <span className="info-value">{registryData.parttime_employees}</span>
                        </div>
                      )}
                    {registryData.total_branches !== null &&
                      registryData.total_branches !== undefined && (
                        <div className="info-row">
                          <span className="info-label">Total Branches:</span>
                          <span className="info-value">{registryData.total_branches}</span>
                        </div>
                      )}
                    {registryData.commercial_branches !== null &&
                      registryData.commercial_branches !== undefined && (
                        <div className="info-row">
                          <span className="info-label">Commercial:</span>
                          <span className="info-value">{registryData.commercial_branches}</span>
                        </div>
                      )}
                    {registryData.non_commercial_branches !== null &&
                      registryData.non_commercial_branches !== undefined && (
                        <div className="info-row">
