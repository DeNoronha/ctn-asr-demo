...
echo "Searching all legal entities for LK Holding..."
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://ca-ctn-asr-api-dev.calmriver-700a8c55.westeurope.azurecontainerapps.io/api/v1/legal-entities" | jq '.data[] | select(.primary_legal_name | test("LK|Holding"; "i"))'
