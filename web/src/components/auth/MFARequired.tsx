    ...
    <div className="mfa-container">
      <div className="mfa-card">
        ...
        <div className="mfa-message">
          ...
          <p>
            Please enable MFA in your Microsoft account settings and try logging in again.
          </p>
        </div>
        ...
        <div className="mfa-steps">
          ...
          <ol>
            <li>Go to <a href="https://mysignins.microsoft.com/security-info" target="_blank" rel="noopener noreferrer">Microsoft Security Info</a></li>
