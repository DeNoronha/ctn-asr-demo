...
const dcsaSchemas_1 = require("../shared/dcsaSchemas");
...
const httpTrigger = async function (context, req) {
    ...
    try {
        ...
        // Parse request body
        const { documentId, documentType, carrier, documentText, extractedData, confidenceScore } = req.body || {};
        ...
        const validTypes = ['booking_confirmation', 'bill_of_lading', 'delivery_order', 'transport_order'];
        ...
        if (!(0, knowledgeBase_1.shouldAddToKnowledgeBase)(score, validation.errors)) {
            context.res = {
                status: 400,
                body: {
        ...
        const example = await (0, knowledgeBase_1.addToKnowledgeBase)(documentType, carrier.toLowerCase(), documentText, extractedData, user.email, score);
