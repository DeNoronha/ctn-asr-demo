...
const pdfExtractor_1 = require("../shared/pdfExtractor");
const documentClassifier_1 = require("../shared/documentClassifier");
const claudeExtractor_1 = require("../shared/claudeExtractor");
...
const httpTrigger = async function (context, req) {
    ...
    try {
        ...
        const pageCount = await (0, pdfExtractor_1.getPdfPageCount)(file);
        ...
        (0, knowledgeBase_1.initializeKnowledgeBase)(COSMOS_ENDPOINT, COSMOS_KEY, COSMOS_DATABASE_NAME, 'knowledge-base');
        // Extract text from PDF
        context.log('Extracting text from PDF...');
        const extractionStartTime = Date.now();
        const pdfResult = await (0, pdfExtractor_1.extractTextFromPDF)(file);
        ...
        const documentGroups = await (0, pdfExtractor_1.groupPagesIntoDocuments)(file);
        ...
        for (const group of documentGroups) {
            ...
            try {
                ...
                const classification = (0, documentClassifier_1.classifyDocument)(group.combinedText);
                ...
                const fewShotExamples = await (0, knowledgeBase_1.getFewShotExamples)(classification.documentType, classification.carrier, 5);
                ...
                const extraction = await (0, claudeExtractor_1.extractWithClaude)({
                ...
                const documentRecord = {
                    id: documentId,
                    documentType: classification.documentType,
                    documentNumber: extraction.data.carrierBookingReference ||
                        extraction.data.billOfLadingNumber ||
                        extraction.data.deliveryOrderNumber ||
                        extraction.data.transportOrderNumber ||
                        documentId,
                    carrier: classification.carrier,
