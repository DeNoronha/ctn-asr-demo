...
export const M2MClientsView: React.FC<M2MClientsViewProps> = ({
  ...
  // Generate preview Client ID when modal opens
  useEffect(() => {
    if (showAddDialog && !previewClientId) {
        ...
        <div style={{ padding: '20px 0' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <TextInput
              ...
              readOnly
              placeholder="Client ID will be generated automatically"
              style={{ width: '100%' }}
              styles={{
                input: {
            ...
            />
            <p style={{ fontSize: '0.75rem', color: '#666', margin: '4px 0 0 0' }}>
              Preview only - actual Client ID will be generated by the server
            </p>
          </div>
