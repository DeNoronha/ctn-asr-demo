-- Migration 029: Link M2M Credentials to Published Endpoints
...
-- ========================================
-- Note: Legacy access_tokens table will be added in future migration
-- when legacy token functionality is implemented
-- ========================================
