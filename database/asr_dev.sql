...
--
-- Name: audit_log_pii_mapping; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.audit_log_pii_mapping (
    pseudonym character varying(64) NOT NULL,
...
--
-- Name: TABLE audit_log_pii_mapping; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.audit_log_pii_mapping IS 'Encrypted mapping of pseudonyms to original PII values. RESTRICTED ACCESS: SystemAdmin only. GDPR Article 32 - Encryption of Personal Data.';


--
-- Name: COLUMN audit_log_pii_mapping.pseudonym; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.audit_log_pii_mapping.pseudonym IS 'Pseudonymized value (email_xxx or ipv4_xxx or ipv6_xxx)';


--
-- Name: COLUMN audit_log_pii_mapping.encrypted_value; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.audit_log_pii_mapping.encrypted_value IS 'Original PII value encrypted with pgp_sym_encrypt() using PII_ENCRYPTION_KEY';


--
-- Name: COLUMN audit_log_pii_mapping.created_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.audit_log_pii_mapping.created_by IS 'User ID who created this mapping (for audit trail)';
...
--
-- Name: bdi_external_systems; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bdi_external_systems (
...
--
-- Name: TABLE bdi_external_systems; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.bdi_external_systems IS 'External BDI systems authorized to access CTN ASR APIs';


--
-- Name: COLUMN bdi_external_systems.keycloak_client_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_external_systems.keycloak_client_id IS 'Keycloak client ID for authentication';


--
-- Name: COLUMN bdi_external_systems.allowed_operations; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_external_systems.allowed_operations IS 'Array of allowed operations: bvad_generate, bvod_validate, member_lookup';


--
-- Name: bdi_orchestration_participants; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bdi_orchestration_participants (
...
--
-- Name: TABLE bdi_orchestration_participants; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.bdi_orchestration_participants IS 'Members/entities involved in BDI orchestrations';


--
-- Name: COLUMN bdi_orchestration_participants.participant_role; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_orchestration_participants.participant_role IS 'Role in orchestration: Carrier, Forwarder, Terminal, Customs Broker, etc.';


--
-- Name: COLUMN bdi_orchestration_participants.authorized_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_orchestration_participants.authorized_by IS 'Entity that authorized this participant involvement';


--
-- Name: bdi_orchestrations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bdi_orchestrations (
...
--
-- Name: TABLE bdi_orchestrations; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.bdi_orchestrations IS 'BDI orchestration instances tracking transport/logistics workflows';


--
-- Name: COLUMN bdi_orchestrations.internal_order_identifier; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_orchestrations.internal_order_identifier IS 'Internal order/shipment reference from orchestrator';


--
-- Name: COLUMN bdi_orchestrations.business_keys; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_orchestrations.business_keys IS 'Business identifiers like Bill of Lading, Container numbers';


--
-- Name: COLUMN bdi_orchestrations.status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bdi_orchestrations.status IS 'Orchestration status: active, completed, cancelled';


--
-- Name: bvad_issued_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bvad_issued_tokens (
...
--
-- Name: TABLE bvad_issued_tokens; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.bvad_issued_tokens IS 'Audit trail of issued BVAD tokens for member trust verification';


--
-- Name: COLUMN bvad_issued_tokens.jti; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bvad_issued_tokens.jti IS 'JWT ID from jti claim - unique identifier';


--
-- Name: COLUMN bvad_issued_tokens.claims_snapshot; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bvad_issued_tokens.claims_snapshot IS 'Snapshot of all claims at issuance time';


--
-- Name: COLUMN bvad_issued_tokens.usage_count; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bvad_issued_tokens.usage_count IS 'Number of times this token was validated';


--
-- Name: bvod_validation_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bvod_validation_log (
...
--
-- Name: TABLE bvod_validation_log; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.bvod_validation_log IS 'Audit log of BVOD validation requests for security monitoring';


--
-- Name: COLUMN bvod_validation_log.validation_result; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bvod_validation_log.validation_result IS 'Result: valid, invalid, expired, revoked, not_found, signature_invalid';


--
-- Name: COLUMN bvod_validation_log.member_found_in_orchestration; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.bvod_validation_log.member_found_in_orchestration IS 'Was the requested member actually involved in the orchestration?';
...
--
-- Name: endpoint_authorization; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.endpoint_authorization (
...
CREATE TABLE public.members (
    ...
    CONSTRAINT chk_members_email_format CHECK (((email IS NULL) OR ((email)::text ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'::text))),
    CONSTRAINT chk_members_org_id_format CHECK (((org_id IS NOT NULL) AND (length(TRIM(BOTH FROM org_id)) > 0)))
);
...
COMMENT ON TABLE public.members IS 'Member organizations in the CTN Association Register. Contains member-specific data (org_id, Azure AD integration). All other organization details stored in legal_entity table (1:1 relationship enforced by uq_members_legal_entity_id). Updated 2025-11-13 (Migration 028 - removed duplicate columns).';


--
-- Name: COLUMN members.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN members.org_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.members.org_id IS 'Organization identifier (format: org:name, e.g., org:dhl). Must be unique. Used in API URLs and OAuth client registration.';


--
-- Name: COLUMN members.metadata; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.members.metadata IS 'JSONB field for member-specific metadata (e.g., onboarding status, preferences). Allows schema evolution without migrations.';


--
-- Name: COLUMN members.legal_entity_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.members.legal_entity_id IS 'Foreign key to legal_entity table. UNIQUE constraint ensures 1:1 relationship (one member per legal_entity). NOT NULL - all members must have legal_entity.';


--
-- Name: COLUMN members.azure_ad_object_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.members.azure_ad_object_id IS 'Azure AD B2C object ID for the member organization. Used for Azure AD authentication integration.';
...
COMMENT ON COLUMN public.members.email IS 'Primary contact email for the member organization. Used for notifications and password reset.';


--
-- Name: CONSTRAINT chk_members_email_format ON members; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON CONSTRAINT chk_members_email_format ON public.members IS 'Validates email format if provided (nullable field)';


--
-- Name: CONSTRAINT chk_members_org_id_format ON members; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON CONSTRAINT chk_members_org_id_format ON public.members IS 'Ensures org_id is not null or empty. Accepts multiple formats: org:name, UUIDs, or alphanumeric codes';
...
--
-- Name: audit_log_pii_mapping audit_log_pii_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.audit_log_pii_mapping
    ADD CONSTRAINT audit_log_pii_mapping_pkey PRIMARY KEY (pseudonym);
...
--
-- Name: bdi_external_systems bdi_external_systems_keycloak_client_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_external_systems
    ADD CONSTRAINT bdi_external_systems_keycloak_client_id_key UNIQUE (keycloak_client_id);


--
-- Name: bdi_external_systems bdi_external_systems_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_external_systems
    ADD CONSTRAINT bdi_external_systems_pkey PRIMARY KEY (system_id);


--
-- Name: bdi_external_systems bdi_external_systems_system_domain_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_external_systems
    ADD CONSTRAINT bdi_external_systems_system_domain_key UNIQUE (system_domain);


--
-- Name: bdi_orchestration_participants bdi_orchestration_participants_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_orchestration_participants
    ADD CONSTRAINT bdi_orchestration_participants_pkey PRIMARY KEY (participant_id);


--
-- Name: bdi_orchestrations bdi_orchestrations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_orchestrations
    ADD CONSTRAINT bdi_orchestrations_pkey PRIMARY KEY (orchestration_id);


--
-- Name: bvad_issued_tokens bvad_issued_tokens_jti_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bvad_issued_tokens
    ADD CONSTRAINT bvad_issued_tokens_jti_key UNIQUE (jti);


--
-- Name: bvad_issued_tokens bvad_issued_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bvad_issued_tokens
    ADD CONSTRAINT bvad_issued_tokens_pkey PRIMARY KEY (bvad_token_id);


--
-- Name: bvod_validation_log bvod_validation_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bvod_validation_log
    ADD CONSTRAINT bvod_validation_log_pkey PRIMARY KEY (validation_id);
...
--
-- Name: endpoint_authorization endpoint_authorization_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.endpoint_authorization
    ADD CONSTRAINT endpoint_authorization_pkey PRIMARY KEY (endpoint_authorization_id);
...
--
-- Name: members members_org_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_org_id_key UNIQUE (org_id);
...
--
-- Name: bdi_orchestration_participants uq_orchestration_participant; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_bdi_systems_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bdi_systems_client; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bdi_systems_domain; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvad_tokens_cleanup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bvad_tokens_cleanup ON public.bvad_issued_tokens USING btree (expires_at) WHERE (expires_at IS NOT NULL);


--
-- Name: INDEX idx_bvad_tokens_cleanup; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.idx_bvad_tokens_cleanup IS 'Optimizes BVAD expired token cleanup queries';


--
-- Name: idx_bvad_tokens_entity; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvad_tokens_expires; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvad_tokens_issued; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvad_tokens_jti; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvad_tokens_subject; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_jti; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_member; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_orchestration; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_requested; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_requestor; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bvod_validation_result; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_endpoint_authorization_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_endpoint_authorization_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_endpoint_authorization_endpoint; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_endpoint_authorization_expires; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_members_azure_ad_oid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_members_azure_ad_oid_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_members_legal_entity_id_orphan_check; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_members_legal_entity_id_orphan_check ON public.members USING btree (legal_entity_id) WHERE (legal_entity_id IS NOT NULL);


--
-- Name: idx_members_org_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_orchestrations_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_orchestrations_customer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_orchestrations_orchestrator; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_orchestrations_order_ref; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_orchestrations_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participants_domain; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participants_entity; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participants_orchestration; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participants_role; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_pii_mapping_created_by ON public.audit_log_pii_mapping USING btree (created_by);


--
-- Name: idx_pii_mapping_dt_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pii_mapping_dt_created ON public.audit_log_pii_mapping USING btree (dt_created);
...
--
-- Name: uq_members_legal_entity_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_members_legal_entity_id ON public.members USING btree (legal_entity_id);


--
-- Name: INDEX uq_members_legal_entity_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.uq_members_legal_entity_id IS 'Ensures 1:1 relationship between members and legal_entity (one member per legal_entity)';


--
-- Name: bdi_orchestrations trg_bdi_orchestrations_modified; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_bdi_orchestrations_modified BEFORE UPDATE ON public.bdi_orchestrations FOR EACH ROW EXECUTE FUNCTION public.update_modified_timestamp();


--
-- Name: bdi_orchestration_participants trg_bdi_participants_modified; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_bdi_participants_modified BEFORE UPDATE ON public.bdi_orchestration_participants FOR EACH ROW EXECUTE FUNCTION public.update_modified_timestamp();


--
-- Name: bdi_external_systems trg_bdi_systems_modified; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_bdi_systems_modified BEFORE UPDATE ON public.bdi_external_systems FOR EACH ROW EXECUTE FUNCTION public.update_modified_timestamp();


--
-- Name: endpoint_authorization trg_endpoint_authorization_modified; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_endpoint_authorization_modified BEFORE UPDATE ON public.endpoint_authorization FOR EACH ROW EXECUTE FUNCTION public.update_modified_timestamp();
...
--
-- Name: bdi_orchestration_participants bdi_orchestration_participants_legal_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_orchestration_participants
    ADD CONSTRAINT bdi_orchestration_participants_legal_entity_id_fkey FOREIGN KEY (legal_entity_id) REFERENCES public.legal_entity(legal_entity_id);


--
-- Name: bdi_orchestration_participants bdi_orchestration_participants_orchestration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bdi_orchestration_participants
    ADD CONSTRAINT bdi_orchestration_participants_orchestration_id_fkey FOREIGN KEY (orchestration_id) REFERENCES public.bdi_orchestrations(orchestration_id) ON DELETE CASCADE;


--
-- Name: bvad_issued_tokens bvad_issued_tokens_legal_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bvad_issued_tokens
    ADD CONSTRAINT bvad_issued_tokens_legal_entity_id_fkey FOREIGN KEY (legal_entity_id) REFERENCES public.legal_entity(legal_entity_id);


--
-- Name: bvod_validation_log bvod_validation_log_orchestration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bvod_validation_log
    ADD CONSTRAINT bvod_validation_log_orchestration_id_fkey FOREIGN KEY (orchestration_id) REFERENCES public.bdi_orchestrations(orchestration_id);
...
--
-- Name: endpoint_authorization fk_endpoint_authorization; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.endpoint_authorization
    ADD CONSTRAINT fk_endpoint_authorization FOREIGN KEY (legal_entity_endpoint_id) REFERENCES public.legal_entity_endpoint(legal_entity_endpoint_id) ON DELETE CASCADE;
...
--
-- Name: issued_tokens issued_tokens_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.issued_tokens
    ADD CONSTRAINT issued_tokens_member_id_fkey FOREIGN KEY (member_id) REFERENCES public.members(id) ON DELETE CASCADE;
...
--
-- Name: members members_legal_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_legal_entity_id_fkey FOREIGN KEY (legal_entity_id) REFERENCES public.legal_entity(legal_entity_id) ON UPDATE CASCADE ON DELETE RESTRICT;
