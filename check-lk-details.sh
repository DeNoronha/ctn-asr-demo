...
echo "LK Holding application details:"
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://ca-ctn-asr-api-dev.calmriver-700a8c55.westeurope.azurecontainerapps.io/api/v1/applications/8f4a8572-29ec-4ca8-be67-cca5f9ef1c0c" | jq '.'
