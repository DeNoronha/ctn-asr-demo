...
async function handler(
  ...
  try {
    ...
    // Decode token to get jti and claims for audit logging
    // SECURITY: Safe to decode without verification - token was just generated by us
    // (not external/untrusted input). Decoding only for extracting metadata (JTI, claims).
