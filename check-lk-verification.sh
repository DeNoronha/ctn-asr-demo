...
echo "LK Holding KvK verification status:"
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://ca-ctn-asr-api-dev.calmriver-700a8c55.westeurope.azurecontainerapps.io/api/v1/legal-entities/8fc8562b-96d5-4a97-9195-a8682abefee5/kvk-verification" | jq '{kvk_verification_status, kvk_document_url, kvk_number}'
